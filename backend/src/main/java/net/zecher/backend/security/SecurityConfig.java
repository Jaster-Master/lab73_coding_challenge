...
import net.zecher.backend.controller.TrafficSignObservationController;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth.requestMatchers(TrafficSignObservationController.CONTROLLER_PATH + "/**").authenticated())
